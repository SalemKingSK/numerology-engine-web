...
const p1 = reduceMN(reduce(birthMonth) + reduce(birthDay));
const p2 = reduceMN(reduce(birthDay) + reduce(birthYear));
const p3 = reduceMN(p1 + p2);
const p4 = reduceMN(reduce(birthMonth) + reduce(birthYear));
const p1end = 36 - lp;
const p2end = p1end + 9;
const p3end = p2end + 9;
