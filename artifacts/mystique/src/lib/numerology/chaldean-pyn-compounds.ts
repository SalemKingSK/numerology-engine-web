...
const COMPOUND_LIST: ChaldeanPYNCompound[] = [
  ...
  {
    compound: 10, reduced: 1,
    name: "The Wheel of Fortune",
    isKarmicDebt: false, isMasterNumber: false,
    symbolism: "The Wheel of Fortune, turning endlessly — Isis and Osiris governing rise and fall according to the wheel's rotation.",
...

  {
    ...
    karmicDynamics: "The 37/1 often resolves karmic patterns around isolation and self-sufficiency taken to excess. Past lives where the individual refused help, rejected partnership, or insisted on solitary paths created imbalances that this period's energy corrects through the magnetic attraction of beneficial alliances. The Royal Star of Taurus symbolism suggests that the period's partnerships carry a quality of divine blessing — connections that feel fated, encounters that transform the trajectory of the individual's life.",
...

  {
    ...
    vibrationalEssence: "The 46/1 carries the same fundamental vibration as 37/1. However, the 46 compound introduces the 4's structural discipline and the 6's nurturing responsibility into the 1's initiating energy, producing a partnership-oriented period with distinctly practical and domestic dimensions.\n\nThe 4's influence adds methodical planning and systematic effort to the period's alliance-building activities. Partnerships formed during 46/1 tend to be characterized by clear agreements, defined responsibilities, and structured approaches to shared goals. The 6's influence introduces care, service, and relational commitment — partnerships that are not merely advantageous but genuinely nurturing.",
    manifestationPatterns: "The 46/1 produces partnerships that are both fortunate and durable. The individual attracts allies who bring not only opportunity but stability — people who commit, who follow through, who invest in the long-term success of shared endeavors. Professional collaborations benefit from clear structure and mutual accountability. Personal relationships develop through demonstrable care and practical support.\n\nThe period's initiatives succeed when built on solid foundations. The 4's structural energy demands that plans be thoroughly researched, resources carefully allocated, and timelines realistically established. The 6's nurturing energy requires that all collaborations include attention to the human element — relationships maintained, feelings considered."
  },

  {
    compound: 55, reduced: 1,
    name: "The Sword",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "The Sword — triumph and victory over difficulties; a protection and yet a menace; may chastise as it may confer honours.",
    vibrationalEssence: "The 55/1 introduces one of the Power Numbers — double-digit numbers with identical digits that carry intensified vibrational force. Sepharial described 55 as 'The Sword,' emphasizing its dual capacity to cut through obstacles and to wound. The 55 reduces to 10 (5+5=10), which then reduces to 1, so it carries the Wheel of Fortune's karmic momentum amplified by the Power Number's intensification. The 5's energy of change, freedom, and dynamic movement operates at double strength, producing a period where circumstances shift rapidly and the individual's capacity for adaptability is continually tested.",
    karmicDynamics: "The Sword symbolism carries precise karmic meaning: the period brings situations that require decisive cutting — severing attachments, ending dependencies, breaking patterns that have outlived their usefulness. The individual who wields the sword wisely achieves triumph over difficulties; the individual who fails to act decisively may find themselves wounded by the very circumstances they sought to avoid.",
    manifestationPatterns: "The 55/1 produces rapid developments and sudden shifts. Initiatives launched during this cycle gain momentum quickly but may also encounter resistance that requires forceful response. The period's energy supports ventures requiring courage, boldness, and willingness to take calculated risks. Success comes to those who act decisively when opportunity appears and who cut their losses promptly when circumstances turn unfavorable.\n\nThe compound number's warning is equally important: the sword that cuts through obstacles can also wound the wielder. Aggressive action and forceful interventions may produce short-term gains at the cost of long-term relationships."
  },

  {
    compound: 64, reduced: 1,
    name: "The Creative Innovator",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Same essence as 46/1, with the 6's nurture and 4's structure expressed through a higher octave of creative innovation.",
...

  {
    ...
    manifestationPatterns: "The 73/1 produces recognition for intellectual and creative achievement. The individual's ideas gain traction; their proposals attract support; their leadership is sought after in projects requiring both vision and analytical precision. Professional advancement comes through demonstrated expertise rather than political maneuvering."
  },

  {
    compound: 82, reduced: 1,
    name: "The Survivor's Renewal",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Same essence as 28/1 — the cycle of promise, loss, and renewal operating through a higher octave.",
  ...
  {
    compound: 56, reduced: 2,
    name: "The Clenched Hand",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Same essence as 11/2 — hidden dangers, trial, and treachery from others; a clenched hand; a lion muzzled.",
    vibrationalEssence: "The 56/2 reduces to 11 (5+6=11), carrying the Master Number with the 5's dynamic change and the 6's nurturing responsibility. This compound produces a period of significant transition in relationships, where the hidden trials of the 11 manifest through domestic and family-related challenges.",
    manifestationPatterns: "The 56/2 produces changes in domestic partnerships and family relationships. The individual may face decisions about relocation that affect partnerships, or may experience tests in relationships with family members who require care or support. The period's hidden dangers often manifest through the individual's own tendency to sacrifice too much for others — the 6's nurturing energy, taken to excess, can create unhealthy dependency patterns that the 11's trials force into awareness."
  },

  {
    compound: 65, reduced: 2,
    name: "The Master Number Tension",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Same essence as 56/2 and 11/2, with intensified Master Number energy balancing freedom and domestic commitment.",
    vibrationalEssence: "The 65/2 reduces to 11 (6+5=11), carrying the same Master Number foundation as 56/2 with the digits reversed. World numerology sources note that 65 is 'the same as 11' but with an important addition: 'The need to balance freedom and domestic affairs (commitment) is even more important here.'",
    manifestationPatterns: "The 65/2 produces tension between commitment and freedom in relationships. The individual may feel drawn to partnership while simultaneously experiencing restlessness and desire for independence. Partners may mirror this conflict, demanding commitment while acting unpredictably. The period's lesson is integration — finding ways to honor both the need for connection and the need for autonomy within the same relationship structures."
  },

  {
    compound: 74, reduced: 2,
    name: "The Master Force with Premonitions",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Same essence as 47/2 and 11/2, bringing premonitions and intense dreams.",
    vibrationalEssence: "The 74/2 reduces to 11 (7+4=11), carrying the Master Number with the 7's spiritual depth and the 4's structural discipline. World numerology sources specifically note that 74 'is the same as 11' with the addition that 'It brings premonitions and intense dreams.'",
    manifestationPatterns: "The 74/2 produces vivid dreams, strong hunches, and uncanny synchronicities that provide guidance about relationship decisions. The individual may find themselves knowing things about partners or situations without being able to explain how they know. The challenge lies in distinguishing genuine intuition from anxiety-driven projection, and in grounding intense psychic experiences in practical self-care routines."
  },

  {
    compound: 83, reduced: 2,
    name: "The Business-Oriented Pragmatist",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Same essence as 38/2 and 29/2, more business-oriented and less sensitive.",
    vibrationalEssence: "The 83/2 reduces to 11 (8+3=11), carrying the Master Number with the 8's material power and the 3's creative expression. World numerology sources note that 83 'is the same as 38 and 11' but 'is more business-oriented and less sensitive and vulnerable.'",
    manifestationPatterns: "The 83/2 produces challenges in business partnerships and professional collaborations. The individual's creative contributions may be undervalued or exploited by associates who focus on financial outcomes rather than artistic quality. The period's lesson is learning to protect creative interests through proper business arrangements while maintaining the capacity for genuine professional connection."
  },

  {
    compound: 92, reduced: 2,
    name: "The Humanitarian Master",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Same essence as 29/2 and 11/2, with great concern for mankind.",
    vibrationalEssence: "The 92/2 reduces to 11 (9+2=11), carrying the Master Number with the 9's humanitarian compassion and the 2's receptive sensitivity. World numerology sources note that 92 'is the same as 29 and 11' with the addition that 'This number brings great concern for mankind.'",
    manifestationPatterns: "The 92/2 produces relationship experiences that expand the individual's compassion and concern for collective well-being. Personal betrayals and disappointments are processed through a lens of universal human experience; the individual emerges from the period with both deepened relationship discernment and strengthened commitment to serving human welfare."
  },

  // ── PERSONAL YEAR 3: EXPRESSION ──────────────────────────────────────────

  {
    compound: 12, reduced: 3,
    name: "The Sacrifice",
    isKarmicDebt: false, isMasterNumber: false,
...

  {
    ...
    karmicDynamics: "The 21/3 often represents the flowering of karma cultivated through previous cycles of disciplined effort. The 'long initiation' Cheiro referenced suggests that the period's honors are not arbitrary gifts but earned rewards for sustained creative work. Past-life patterns of dedicated practice, of honing skills through repeated effort, of maintaining creative commitment despite obstacles — all of these create the foundation for the period's success.",
    manifestationPatterns: "The 21/3 produces visible advancement in creative and professional domains. The individual's work gains public recognition; their communication skills open doors to new opportunities; their social presence attracts influential connections. Honors, awards, promotions, and public acknowledgment characterize this cycle. The period's creative output tends to be not merely prolific but also distinguished — work that rises above the ordinary and commands respect.\n\nThe Crown of the Magi symbolism carries a specific spiritual dimension. The 'Magi' were initiated priests, guardians of esoteric knowledge. The 21/3 success is not merely material or social but carries a quality of spiritual legitimacy."
  },

  {
    compound: 30, reduced: 3,
    name: "The Thoughtful Deduction",
    isKarmicDebt: false, isMasterNumber: false,
    symbolism: "Thoughtful deduction, retrospection, and mental superiority over one's fellows.",
    vibrationalEssence: "The 30/3 introduces a quality of intellectual detachment into the 3's normally social and expressive cycle. The 3's creative energy combines with the 0's mystical amplification, producing a period where mental activity dominates emotional and social engagement. Cheiro observed that this number 'seems to belong completely to the mental plane,' and that those it represents 'are likely to put all material things on one side — not because they have to, but because they wish to do so.'",
    manifestationPatterns: "The 30/3 produces significant mental productivity. The individual's creative energy channels into intellectual rather than social or artistic expression. They may complete major writing projects, develop theoretical frameworks, or produce analytical works that demonstrate the 'mental superiority' Cheiro described.\n\nCheiro described 30 as 'neither fortunate nor unfortunate, for either depends on the mental outlook of the person it represents.' The period's outcomes are determined entirely by how the individual directs their mental energy. Clear, constructive thinking produces powerful results; scattered or negative thinking yields indifferent outcomes."
  },

  {
    compound: 39, reduced: 3,
    name: "The Creative Multiplicity",
    isKarmicDebt: false, isMasterNumber: false,
    symbolism: "Same essence as 30/3, keeping many projects going so that life works out.",
    vibrationalEssence: "The 39/3 reduces to 12 (3+9=12), then to 3, carrying the thoughtful deduction energy of 30/3 with the 9's completion and the 3's creative expression intensified. This compound produces a period of creative abundance and multiple projects, where the individual's expressive energy extends in many directions simultaneously.",
    manifestationPatterns: "The 39/3 produces a busy creative life with many projects in various stages of development. The individual may write, teach, perform, and organize simultaneously, finding that their creative energy expands to fill multiple channels. The challenge lies in completion; the 9's influence brings many initiatives to fruition, but the multiplicity of projects requires disciplined focus to ensure that nothing important remains unfinished."
  },

  {
    compound: 48, reduced: 3,
    name: "The Frictioned Visionary",
    isKarmicDebt: false, isMasterNumber: false,
    symbolism: "Same essence as 39/3 and 30/3, visionary but with efforts brought down by friction from all sides.",
    vibrationalEssence: "The 48/3 reduces to 12 (4+8=12), then to 3, carrying the 30/3 energy with the 4's structural discipline and the 8's material power. This compound produces a period of significant creative vision coupled with practical challenges that obstruct the vision's realization. The compound number's reduction through 12 introduces the Sacrifice vibration, meaning that the period's creative efforts encounter resistance, opposition, and friction.",
    manifestationPatterns: "The 48/3 produces ambitious creative projects that encounter practical obstacles. The individual's vision is clear and their capacity for implementation is strong, but external circumstances — bureaucratic delays, financial constraints, opposition from established interests — create friction that slows progress. The period's lesson is persistence in the face of resistance, maintaining creative vision while developing strategies for navigating practical obstacles."
  },

  {
    compound: 57, reduced: 3,
    name: "The Intelligent Inventor",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Same essence as 30/3, with the 5's dynamic intelligence and 7's spiritual invention.",
    vibrationalEssence: "The 57/3 reduces to 12 (5+7=12), then to 3, carrying the 30/3 mental energy with the 5's versatile intelligence and the 7's spiritual depth. This compound produces a period of inventive creativity, where the individual's expression takes unusual, innovative, and sometimes unprecedented forms.",
    manifestationPatterns: "The 57/3 produces creative work that breaks established patterns and introduces new approaches. The individual's expression may surprise even themselves, as the 7's spiritual channel opens access to ideas and perspectives that lie beyond conventional thinking. The period's creative output tends to be ahead of its time."
  },

  {
    compound: 66, reduced: 3,
    name: "The Generous Creator",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Generous to a fault, with financial ups and downs; extremely creative, loyal, and loving.",
    ...
    manifestationPatterns: "The 66/3 produces abundant creative output that is enthusiastically received. The individual's generosity of spirit attracts loyal audiences and appreciative communities. However, the 'financial ups and downs' warning is significant: the period's creative success may not translate directly into monetary stability, as the individual's generous nature may lead them to undercharge for their work or to give away more than is sustainable."
  },

  {
    compound: 75, reduced: 3,
    name: "The Analytical Inventor",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Same essence as 57/3, more analytical and less creative.",
    vibrationalEssence: "The 75/3 reduces to 12 (7+5=12), then to 3. World numerology sources note that 75 'is more analytical and less creative' than 57. The period's expression tends toward systematic analysis, structured argument, and methodical presentation.",
    manifestationPatterns: "The 75/3 produces creative work that is intellectually demanding and analytically rigorous. The individual's expression may take the form of scholarly writing, technical communication, or systematic artistic approaches that prioritize structure over spontaneity."
  },

  {
    compound: 84, reduced: 3,
    name: "The Visionary Idealist",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Same essence as 48/3, more visionary and less organized.",
    vibrationalEssence: "The 84/3 reduces to 12 (8+4=12), then to 3. World numerology sources note that 84 'is more the visionary and less the organizer.' The period's creative expression is characterized by bold, expansive vision that may exceed the individual's practical capacity for execution.",
    manifestationPatterns: "The 84/3 produces grand creative visions and ambitious expressive projects. The individual sees possibilities on a large scale and communicates their vision with compelling enthusiasm. The challenge lies in grounding the vision in practical reality; the period's creative successes come when the individual partners with others who can provide the organizational skills that complement their visionary capacity."
  },

  {
    compound: 93, reduced: 3,
    name: "The Marvelous Capabilities",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Capable of doing marvelous things; worldly knowledge; excellence in histrionics.",
    vibrationalEssence: "The 93/3 reduces to 12 (9+3=12), then to 3. The Chaldean source describes those under 93 as 'capable of doing marvelous things. They improve their worldly knowledge and are lucky to have their desires fulfilled. They excel in the field of histrionics through which they attain more fame.'",
    manifestationPatterns: "The 93/3 produces creative accomplishments that attract public recognition and admiration. The individual's expressive abilities seem to operate at peak capacity, producing work that is both technically accomplished and emotionally resonant. The period's creative endeavors tend to fulfill the individual's desires while also serving audiences who find value and inspiration in their output."
  },

  // ── PERSONAL YEAR 4: FOUNDATION ──────────────────────────────────────────

  {
    compound: 13, reduced: 4,
    name: "Rebirth",
  ...
  {
    compound: 58, reduced: 4,
    name: "The Destined Success",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Same essence as 31/4, hardworking and destined for success, more masculine.",
    ...
    manifestationPatterns: "The 58/4 produces solid material progress through determined effort. The individual's systematic approach is amplified by the 8's executive capacity and the 5's adaptability, producing foundations that are not only structurally sound but also financially substantial."
  },

  {
    compound: 67, reduced: 4,
    name: "The Inventive Analyst",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Same essence as 31/4, merging analytical intelligence and creativity; inventors and mathematicians.",
    vibrationalEssence: "The 67/4 reduces to 13 (6+7=13), then to 4. World numerology sources describe 67 as a number that 'merges analytical intelligence and creativity. Inventors and mathematicians often have this number prominent in their chart.'",
    manifestationPatterns: "The 67/4 produces creative solutions to structural challenges. The individual's foundation-building efforts involve invention and innovation — new approaches to old problems, original methods for establishing security, creative structures that serve their purposes more effectively than conventional alternatives."
  },

  {
    compound: 76, reduced: 4,
    name: "The Organizational Excellence",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Same essence as 67/4, excellent for management and organization; can turn ideas into reality.",
    vibrationalEssence: "The 76/4 reduces to 13 (7+6=13), then to 4. World numerology sources describe 76 as 'an excellent number for anyone involved in management or organization. It can turn ideas into reality.'",
    manifestationPatterns: "The 76/4 produces well-organized structures and efficiently managed systems. The individual's foundation-building efforts are characterized by careful planning, systematic implementation, and thorough follow-through. Ideas that have remained abstract in previous cycles become concrete realities during this period."
  },

  {
    compound: 85, reduced: 4,
    name: "The Masculine Determination",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Same essence as 58/4, more masculine and bullish.",
    vibrationalEssence: "The 85/4 reduces to 13 (8+5=13), then to 4. World numerology sources note that 85 'is more masculine, and it can be bullish.' The period's foundation-building is characterized by determined, forceful effort that may border on aggression.",
    manifestationPatterns: "The 85/4 produces solid material foundations through determined effort. The individual's systematic approach is amplified by the 8's executive capacity, producing significant structural achievements. However, the 'bullish' quality may create friction in collaborative relationships."
  },

  {
    compound: 94, reduced: 4,
    name: "The Practical Humanitarian",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Same essence as 49/4, the practical humanitarian who dislikes travel and changes.",
    vibrationalEssence: "The 94/4 reduces to 13 (9+4=13), then to 4. World numerology sources describe 94 as 'the practical humanitarian. It is not comfortable with travel, and dislikes changes.'",
    manifestationPatterns: "The 94/4 produces practical structures that serve humanitarian purposes. The individual's systematic approach to foundation-building creates systems, organizations, or infrastructure that benefits communities and populations. The period's work tends to be locally focused and practically oriented."
  },

  // ── PERSONAL YEAR 5: CHANGE ──────────────────────────────────────────────

  {
    compound: 14, reduced: 5,
    name: "Magnetic Movement",
    isKarmicDebt: true, isMasterNumber: false,
    symbolism: "Movement, combination of people and things; danger from natural elements; fortunate dealings with money but with risk and danger because of others' actions.",
...

  {
    ...
    vibrationalEssence: "The 41/5 reduces to 5 (4+1=5), carrying the 32/5's unexpected power energy with the 4's structural discipline and the 1's initiating force. This compound produces a period where dynamic change operates through leadership, technical expertise, and verbal mastery.",
  ...
  {
    compound: 50, reduced: 5,
    name: "The Debater at Home",
    isKarmicDebt: false, isMasterNumber: false,
    symbolism: "Same essence as 32/5, at home in verbal debate; drawn to technical disciplines.",
    vibrationalEssence: "The 50/5 reduces to 5 (5+0=5), carrying the 5's dynamic energy amplified by the 0's mystical potential. This compound produces a period of intensified change and movement, where the individual's adaptability operates at peak capacity.",
  ...
  {
    compound: 59, reduced: 5,
    name: "The Persuasive Conviction",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Same essence as 32/5, persuasive and convincing.",
    vibrationalEssence: "The 59/5 reduces to 14 (5+9=14), then to 5, carrying the karmic debt energy of 14/5 with the 5's dynamic change and the 9's humanitarian breadth. The Chaldean source describes 59 as 'persuasive and convincing.'",
    manifestationPatterns: "The 59/5 produces significant influence over others through communication and persuasion. The individual's words carry weight; their arguments convince; their presentations persuade. The period's dynamic energy operates through human connection — changes are achieved not through force but through the power of convincing communication."
  },

  {
    compound: 68, reduced: 5,
    name: "The Business Loyalist",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Same essence as 14/5, good for business; loyal with a great sense of humor; tendency to be insensitive.",
    vibrationalEssence: "The 68/5 reduces to 14 (6+8=14), then to 5. World numerology sources describe 68 as 'good for business. It has a tendency to be insensitive, but it is also very loyal. It has a great sense of humor.'",
    manifestationPatterns: "The 68/5 produces business opportunities and professional advancement through loyal partnership. The individual's capacity for change and adaptation serves their business interests, allowing them to navigate shifting conditions and evolving professional landscapes."
  },

  {
    compound: 77, reduced: 5,
    name: "The Intelligent Inventor (Power Number)",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Perhaps the most intelligent and inventive of all numbers; spiritual wisdom; power number.",
    ...
    manifestationPatterns: "The 77/5 produces insights and innovations that transcend conventional understanding. The individual's thinking operates at levels of complexity and creativity that produce genuinely original contributions. The period's dynamic energy channels through intellectual and spiritual exploration, producing changes in understanding that transform the individual's perspective."
  },

  {
    compound: 86, reduced: 5,
    name: "The Self-Oriented Indulgence",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Same essence as 68/5, more self-oriented; somewhat irresponsible and self-indulgent.",
    vibrationalEssence: "The 86/5 reduces to 14 (8+6=14), then to 5. World numerology sources note that 86 'is more self-oriented. It is also somewhat irresponsible and self-indulgent.'",
    manifestationPatterns: "The 86/5 produces material gains and professional advancement through dynamic effort. The individual's capacity for change and adaptation serves their personal ambitions effectively. However, the self-indulgent tendency may lead to overextension or neglect of relationships and responsibilities."
  },

  {
    compound: 95, reduced: 5,
    name: "The Humanitarian Dreamer",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Same essence as 59/5, the humanitarian who is impractical, a dreamer; loves travel and change.",
    vibrationalEssence: "The 95/5 reduces to 14 (9+5=14), then to 5. World numerology sources describe 95 as 'the humanitarian, but is impractical, a dreamer. It loves travel and change.'",
    manifestationPatterns: "The 95/5 produces travel, movement, and new experiences that expand the individual's humanitarian understanding. The period's changes bring encounters with diverse people and cultures, broadening perspective and deepening commitment to collective welfare. The value lies in the expansion of consciousness rather than in material accomplishment."
  },

  // ── PERSONAL YEAR 6: RESPONSIBILITY ──────────────────────────────────────

  {
    compound: 15, reduced: 6,
    name: "The Enchantment",
    isKarmicDebt: true, isMasterNumber: false,
    symbolism: "Revolution, upheaval, strife, failure, and prevention when associated with 4 or 8; enchantment, eloquence, and magnetic charisma otherwise.",
...

  {
    ...
    manifestationPatterns: "The 33/6 produces opportunities for significant service and teaching. The individual's capacity for care and nurture finds expression through roles that guide, heal, or educate others. Their presence becomes a source of inspiration and transformation for those who encounter them. The period's partnerships and relationships carry qualities of spiritual fellowship — connections that support mutual growth in service of higher purposes."
  },

  {
    compound: 42, reduced: 6,
    name: "The Steady Foundation",
    isKarmicDebt: false, isMasterNumber: false,
    symbolism: "Same essence as 24/6, steady and assured; slow and steady.",
    vibrationalEssence: "The 42/6 reduces to 6 (4+2=6), carrying the 24/6's magnetic attraction energy with the 4's structural discipline emphasized. This compound produces a period where nurturing and service are expressed through methodical, systematic effort rather than spontaneous charm.",
    manifestationPatterns: "The 42/6 produces solid, enduring relationships built through patient effort. The individual's care for others is demonstrated through daily actions rather than occasional grand displays. Partnerships formed during this period tend to be characterized by mutual reliability and shared commitment to practical responsibilities. The period's service-oriented efforts yield results that accumulate slowly but prove durable over time."
  },

  {
    compound: 51, reduced: 6,
    ...
    karmicDynamics: "The 51/6 often brings karmic patterns related to past-life military or protective service. The individual who defended their community, who led others through danger, who sacrificed personal safety for collective welfare — now encounters circumstances that activate these established patterns. The period's warrior energy is not aggressive but protective; the individual fights not for conquest but for the preservation of what they value.",
    manifestationPatterns: "The 51/6 produces situations that require courage, decisiveness, and protective leadership. The individual may find themselves in positions where others depend on their strength and judgment; they may encounter circumstances that demand confrontation with opposition or danger. The period's advancement comes through demonstrated bravery and effective leadership in challenging conditions.\n\nThe compound number's warning is explicit: 'it threatens enemies, danger, and the likelihood of assassination.' The warrior's path attracts those who oppose what the individual defends. Self-care and strategic awareness are essential."
  },

  {
    compound: 60, reduced: 6,
    name: "The Loving Caregiver",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Loving, caring, and responsible; sometimes brings subservience.",
    vibrationalEssence: "The 60/6 reduces to 6 (6+0=6), carrying the 6's nurturing energy amplified by the 0's mystical potential. World numerology sources describe 60 as 'loving, caring, and responsible. It sometimes brings subservience.'",
    manifestationPatterns: "The 60/6 produces abundant opportunities for caring service. The individual's nurturing energy attracts people who need their support, creating a period rich in meaningful connection. However, the subservience warning indicates that the individual may give more than is healthy. The period's lesson is learning to care with boundaries — to give generously while maintaining healthy limits."
  },

  {
    compound: 69, reduced: 6,
    name: "Mars Crowned",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Mars crowned — great fortune, reputation, honors by merit; slow but steady development.",
    ...
    manifestationPatterns: "The 69/6 produces gradual but reliable progress toward long-term objectives. The individual's service and care create networks of loyalty and appreciation that support sustained advancement. The period's entrepreneurial energy operates through patient cultivation rather than rapid expansion."
  },

  {
    compound: 78, reduced: 6,
    name: "The Struggle Between Spirit and Matter",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Struggle between the spiritual and the material; making and losing fortunes.",
    vibrationalEssence: "The 78/6 reduces to 15 (7+8=15), then to 6. World numerology sources describe 78 as bringing 'struggle between the spiritual and the material. People with this number prominent in their chart make and lose fortunes.'",
    manifestationPatterns: "The 78/6 produces fluctuating material circumstances that test the individual's commitment to service. Periods of financial abundance may be followed by periods of constraint. The period's lesson is finding ways to serve spiritual purposes while maintaining practical stability."
  },

  {
    compound: 87, reduced: 6,
    name: "The Generous Compassion",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Same essence as 78/6, more practical and better with money, but the struggle remains.",
    vibrationalEssence: "The 87/6 reduces to 15 (8+7=15), then to 6. World numerology sources note that 87 'is somewhat more practical and handles money better, but the struggle between the spiritual and the material is just as intense.'",
    manifestationPatterns: "The 87/6 produces improved material circumstances through practical effort, but with continued awareness of the gap between financial success and spiritual fulfillment. The period's lesson is learning that material and spiritual service are not opposed but can complement each other when approached with wisdom."
  },

  {
    compound: 96, reduced: 6,
    name: "The Self-Sacrificing Community Builder",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Same essence as 69/6, with self-sacrificing nature focused on family, friends, and community.",
    vibrationalEssence: "The 96/6 reduces to 15 (9+6=15), then to 6. World numerology sources describe 96 as having 'self-sacrificing and loving nature… more focused on family, friends, and the community.'",
    manifestationPatterns: "The 96/6 produces extensive contribution to family, friends, and community. The individual's nurturing energy extends widely, creating networks of care and support that benefit many people. The period's self-sacrificing quality requires attention to balance."
  },

  // ── PERSONAL YEAR 7: INTROSPECTION ──────────────────────────────────────

  {
    compound: 16, reduced: 7,
    name: "The Shattered Citadel",
    isKarmicDebt: true, isMasterNumber: false,
    symbolism: "A tower struck by lightning, from which a man with a crown on his head is falling — the Shattered Citadel.",
...

  {
    ...
    manifestationPatterns: "The 25/7 produces situations that test and confirm the individual's hard-won wisdom. Challenges arise that require the application of understanding gained through past difficulties; observations of people and circumstances yield insights that prove practically valuable.\n\nThe compound number's assessment as 'not deemed exactly lucky' is important. The 25/7 does not produce easy success or effortless achievement. Its benefits come through effort, through the active application of experiential wisdom. The period's rewards are substantial but earned."
  },

  {
    compound: 34, reduced: 7,
    name: "The Well-Regarded Balance",
    isKarmicDebt: false, isMasterNumber: false,
    symbolism: "Same essence as 25/7, well-regarded and generous with a good work-life balance.",
    vibrationalEssence: "The 34/7 reduces to 7 (3+4=7), carrying the Wheel of Fortune's karmic momentum with the 3's creative expression and the 4's structural discipline. This compound produces a period where introspective development is balanced with creative productivity and systematic effort.\n\nThe Chaldean source describes 34 as 'well-regarded and generous, with a good work-life balance.'",
...

  {
    ...
    vibrationalEssence: "The 52/7 reduces to 7 (5+2=7), carrying the same fundamental energy as 43/7 but with the digits reversed. The 5's dynamic change combines with the 2's receptive sensitivity, producing a period where the 43/7's revolutionary force operates through emotional and relational channels.\n\nThe Chaldean source describes 52 as having the same meaning as 43, but with the additional quality that those under its influence are 'caring and charitable people who want to bring emotional peace to others.'",
  ...
  {
    compound: 61, reduced: 7,
    name: "Difficulties in Love",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Difficulties in love relationships; demanding and secretive; excellent for researchers.",
    ...
    manifestationPatterns: "The 61/7 produces relationship challenges that yield to analytical investigation. The individual's introspective energy is directed toward understanding the dynamics of intimate connection — the patterns that create attraction and repulsion, the wounds that generate conflict, the needs that drive behavior. The period's difficulties become the raw material for expertise in human relationship."
  },

  {
    compound: 70, reduced: 7,
    name: "The Hermit",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "The hermit's number; a loner and seeker of truth; high intelligence and originality; always eccentric.",
    ...
    manifestationPatterns: "The 70/7 produces powerful experiences of solitary study and spiritual practice. The individual's analytical capacities operate at peak efficiency when directed toward self-directed inquiry; their spiritual sensitivity is heightened by the period's withdrawal from external distraction. However, the warning about losing 'touch with the material world' is significant; the period's challenge is maintaining sufficient practical engagement while pursuing transcendent understanding."
  },

  {
    compound: 79, reduced: 7,
    name: "The Political and Spiritual Leader",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Political and spiritual leaders; concern for mankind; can be ruthless and self-righteous.",
    ...
    manifestationPatterns: "The 79/7 produces opportunities for leadership based on spiritual insight and analytical wisdom. The individual's introspective work yields understanding that others recognize as valuable, drawing them into positions where they can guide collective action. The period's danger lies in the ego's appropriation of spiritual authority; the individual must maintain humility and genuine concern for others' welfare."
  },

  {
    compound: 88, reduced: 7,
    name: "The Contradictory Business Mind",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Full of contradictions; excellent for business but not for relationships; insensitive.",
    vibrationalEssence: "The 88/7 introduces a Power Number into the 7's introspective cycle. World numerology sources describe 88 as 'full of contradictions. It is excellent for business, but it is not good for relationships. It is insensitive.'",
    manifestationPatterns: "The 88/7 produces significant business and professional achievement through analytical insight. The individual's capacity for investigation, research, and strategic thinking yields material results that exceed expectations. However, the period's focus on business success may create distance in personal relationships."
  },

  {
    compound: 97, reduced: 7,
    name: "The Active Thinker",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Proficiency in scriptures and fine arts; eminence in spiritual career; success and prosperity.",
...

  {
    ...
    karmicDynamics: "The 17/8 often represents the flowering of exceptionally positive karma related to past-life spiritual achievement. The individual who dedicated previous incarnations to service, who used their power wisely and compassionately, who rose 'superior in spirit to the trials and difficulties' of human existence — now receives the culmination of that karmic development through a period where material success and spiritual fulfillment converge.",
    manifestationPatterns: "The 17/8 produces material achievement that carries spiritual significance. The individual's professional success, financial gains, and positions of authority are not merely secular accomplishments but expressions of higher purpose. Their leadership inspires others; their business practices embody ethical principles; their material wealth becomes a resource for serving collective welfare.\n\nThe compound number's single warning is important: 17 reduces to 8, and the 8's association with 4 creates potential vulnerability when the number is 'associated with the single number of fours and eights.' The period's spiritual power must be grounded in practical wisdom."
  },

  {
    compound: 26, reduced: 8,
    name: "The Gravest Warnings",
    isKarmicDebt: false, isMasterNumber: false,
    symbolism: "Full of the gravest warnings for the future; disasters brought about by association with others; ruin by bad speculations, partnerships, unions, and bad advice.",
...

  {
    ...
    vibrationalEssence: "The 35/8 reduces to 8 (3+5=8), carrying the same fundamental warning as 26/8 but with the 3's creative expression and the 5's dynamic change modifying the pattern. The Chaldean source explicitly states that 35 'has the same meaning as the number 26' — the dangerous alliance warning applies with equal force.",
    manifestationPatterns: "The 35/8 produces the same partnership dangers as 26/8, but with additional emphasis on creative and professional alliances. The individual's drive for material success may lead them to accept partnerships in creative ventures or dynamic business opportunities that appear promising but prove problematic. The period's lesson is identical: extreme caution in partnership, thorough verification of potential collaborators, and willingness to pursue material goals independently when trustworthy allies are not available."
  },

  {
    compound: 44, reduced: 8,
  ...
  {
    compound: 53, reduced: 8,
    name: "The Verbal Business Creativity",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Same essence as 35/8 and 26/8, more verbal, creative, and business-oriented.",
    vibrationalEssence: "The 53/8 reduces to 8 (5+3=8), carrying the same fundamental warning as 26/8 and 35/8 but with the 5's dynamic communication and the 3's creative expression modifying the pattern. The Chaldean source describes 53 as 'similar to 35, but more verbal, creative, and business-oriented.'",
    manifestationPatterns: "The 53/8 produces partnership dangers in business and creative ventures that involve communication, media, and verbal exchange. The individual's material ambitions may lead them to form alliances in publishing, broadcasting, marketing, or other communication-related fields. The period's lesson remains consistent with the 26/8 warning: extreme caution in partnership and willingness to pursue goals independently."
  },

  {
    compound: 62, reduced: 8,
    name: "The Excellent Caretaker",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Same essence as 26/8, less sensitive; excellent caretaker; good for medical careers.",
...

  {
    ...
    manifestationPatterns: "The 71/8 produces material achievement through powerful executive action, but with accompanying risks to health and physical well-being. The individual's drive for success may lead them to overwork, to neglect self-care, or to pursue material goals with an intensity that damages their body. The period's lesson is learning to wield executive power sustainably."
  },

  {
    compound: 80, reduced: 8,
    name: "The Business Sense Without Independence",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Good for business; found among top management and military; lacks independence.",
    vibrationalEssence: "The 80/8 reduces to 8 (8+0=8), carrying the 8's material power amplified by the 0's mystical potential. World numerology sources describe 80 as 'a good number for business. However, it is found more often among people in top management and the military, than among entrepreneurs, due to a lack of independence.'",
    manifestationPatterns: "The 80/8 produces advancement within established organizations. The individual's executive capacity is recognized and rewarded by existing power structures; they rise to positions of authority within corporations, institutions, or military hierarchies. The period's material success is substantial but operates within frameworks that others have created."
  },

  {
    compound: 89, reduced: 8,
...

  {
    ...
    manifestationPatterns: "The 98/8 produces material success that serves humanitarian purposes. The individual's executive capacity is directed toward social reform, collective welfare, or broad human advancement. However, the idealistic focus may create emotional distance in personal relationships; the period's challenge is maintaining human connection while pursuing large-scale material goals."
  },

  // ── PERSONAL YEAR 9: COMPLETION ──────────────────────────────────────────

  {
    compound: 18, reduced: 9,
    name: "Materialism Striving to Destroy Spirit",
    isKarmicDebt: true, isMasterNumber: false,
    symbolism: "A rayed moon from which drops of blood are falling; a wolf and a hungry dog catching the drops; a crab hastening to join them; materialism striving to destroy the spiritual side of the nature.",
...

  {
    ...
    vibrationalEssence: "The 36/9 reduces to 9 (3+6=9), carrying the 27/9's scepter energy with the 3's creative expression and the 6's nurturing responsibility. The Chaldean source describes 36 as 'creatively influential, puts a lot of effort into being a success, niche is finding the easy way to rise to the top.'",
    manifestationPatterns: "The 36/9 produces creative achievement that gains authoritative recognition. The individual's artistic, communicative, or expressive efforts are acknowledged by those in positions to grant influence and opportunity. The period's completion theme operates through the fruition of creative projects that have been developing through previous cycles."
  },

  {
    compound: 45, reduced: 9,
    name: "The Ambitious Business Success",
    isKarmicDebt: false, isMasterNumber: false,
    symbolism: "Same essence as 27/9, ambition and success in business.",
    vibrationalEssence: "The 45/9 reduces to 9 (4+5=9), carrying the 27/9's scepter energy with the 4's structural discipline and the 5's dynamic change. This compound produces a period where completion and authority are achieved through systematic business achievement and adaptive professional development.",
    manifestationPatterns: "The 45/9 produces business and professional success that culminates in positions of authority. The individual's methodical approach to career development, combined with their adaptability to changing conditions, yields advancement to leadership roles. The period's completion theme operates through the achievement of professional goals that have been pursued through disciplined effort."
  },

  {
    compound: 54, reduced: 9,
    name: "The Less Organized Ambition",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Same essence as 45/9, less organized and disciplined; wants others disadvantaged.",
    vibrationalEssence: "The 54/9 reduces to 9 (5+4=9), carrying the same fundamental energy as 45/9 but with the digits reversed. The Chaldean source describes 54 as 'like 45, but less organized and disciplined, wants others to be disadvantaged so they can cling onto their position.'",
    manifestationPatterns: "The 54/9 produces professional advancement through dynamic effort, but with potential costs to relationships and ethical standing. The individual's ambition may lead them to prioritize personal success over collective welfare. The period's lesson is learning that true authority serves all rather than elevating some at others' expense."
  },

  {
    compound: 63, reduced: 9,
    name: "The Less Outgoing Creativity",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Same essence as 36/9, less outgoing but still creatively influential.",
    vibrationalEssence: "The 63/9 reduces to 9 (6+3=9). World numerology sources describe 63 as 'see 36. It is less outgoing.' The individual's creative contributions are expressed through private, behind-the-scenes efforts that gain recognition through their results rather than their visibility.",
    manifestationPatterns: "The 63/9 produces creative achievement through supportive, nurturing work. The individual's contributions may not be publicly visible, but they are essential to the success of collective endeavors. The period's completion theme operates through the quiet fulfillment of responsibilities that have been sustained through patient effort."
  },

  {
    compound: 72, reduced: 9,
    name: "The Excellent Conversationalist",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Same essence as 27/9, excellent conversationalist and voracious reader.",
    vibrationalEssence: "The 72/9 reduces to 9 (7+2=9). World numerology sources describe 72 as tending 'to be an excellent conversationalist and it is usually a voracious reader.'",
    manifestationPatterns: "The 72/9 produces authority through intellectual engagement. The individual's reading, study, and analysis yield understanding that they share through conversation, teaching, or writing. The period's completion theme operates through the synthesis of accumulated knowledge into wisdom that can be communicated to others."
  },

  {
    compound: 81, reduced: 9,
    name: "The Money-Oriented Materialism",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Same essence as 18/9, more money-oriented, sometimes violent.",
    vibrationalEssence: "The 81/9 reduces to 9 (8+1=9). World numerology sources describe 81 as 'see 18. It is more money-oriented. It often lacks spiritual understanding. Sometimes, this number brings violence.'",
    manifestationPatterns: "The 81/9 produces strong material drives that conflict with the 9's transcendent purpose. The individual may pursue financial goals with an intensity that neglects spiritual development, compassionate service, or relational connection. The violence warning suggests that the period's material ambition may manifest aggressively, creating conflict with others who stand in the way of the individual's financial objectives."
  },

  {
    compound: 90, reduced: 9,
    name: "The Self-Sacrificing Humility",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Self-sacrificing and humble; often brings religious fervor of a positive nature.",
    vibrationalEssence: "The 90/9 reduces to 9 (9+0=9), carrying the 9's transcendent completion energy amplified by the 0's mystical potential. World numerology sources describe 90 as 'self-sacrificing and humble. This number often brings religious fervor, but almost always of a positive and inspiring nature.'",
    manifestationPatterns: "The 90/9 produces experiences of deep spiritual connection and selfless service. The individual's completion of the cycle takes the form of religious or spiritual dedication, humble contribution to collective welfare, and willing sacrifice of personal ambition for higher purposes. The period's religious fervor is constructive rather than fanatical, inspiring rather than coercive."
  },

  {
    compound: 99, reduced: 9,
    name: "The Artistic Genius",
    isKarmicDebt: false, isMasterNumber: false, isExtended: true,
    symbolism: "Artistic genius; often misunderstood; victim of gossip; jealousy and possessiveness in relationships.",
...
export const COMPOUNDS: Record<number, ChaldeanPYNCompound> = Object.fromEntries(
...
export function getCompoundForPYN(
  ...
  function reduceN(n: number): number {
    if (n === 11 || n === 22 || n === 33) return n;
    let v = Math.abs(n);
    while (v > 9) v = String(v).split('').reduce((a, d) => a + +d, 0);
    return v;
  }
  const dRed = reduceN(birthDay);
  const mRed = reduceN(birthMonth);
  const ySum = String(displayYear).split('').reduce((a, c) => a + +c, 0);
